...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const imagenesGaleria = [
    { src: "Imagenes/2-remeras-mangas-largas.jpg", alt: "Remeras mangas largas", categoria: "remeras" },
    { src: "Imagenes/3-camperas-nike.jpg", alt: "Camperas Nike", categoria: "otros" },
    { src: "Imagenes/4-buzos-combinados.jpg", alt: "Buzos combinados", categoria: "otros" },
    { src: "Imagenes/5-camisaco-niño.jpg", alt: "Camisaco niño", categoria: "otros" },
    { src: "Imagenes/6-remera-short-billabong.jpg", alt: "Remera y short Billabong", categoria: "remeras" },
    { src: "Imagenes/7-camperas-vans.jpg", alt: "Camperas Vans", categoria: "otros" },
    { src: "Imagenes/8-remeras-vans.jpg", alt: "Remeras Vans", categoria: "remeras" },
    { src: "Imagenes/9-bermudas-cargo-rusty.jpg", alt: "Bermudas Cargo Rusty", categoria: "bermudas" },
    { src: "Imagenes/10-remeras-billabong.jpg", alt: "Remeras Billabong", categoria: "remeras" },
    { src: "Imagenes/11-remeras-billabong.jpg", alt: "Remeras Billabong", categoria: "remeras" },
    { src: "Imagenes/12-remeras-ripcurl.jpg", alt: "Remeras Ripcurl", categoria: "remeras" },
    { src: "Imagenes/13-remeras-vans.jpg", alt: "Remeras Vans", categoria: "remeras" },
    { src: "Imagenes/14-bermudas-todas-las-marcas.jpg", alt: "Bermudas todas las marcas", categoria: "bermudas" },
    { src: "Imagenes/15-remeras-vans.jpg", alt: "Remeras Vans", categoria: "remeras" },
    { src: "Imagenes/16-campera-pantalon-vans.jpg", alt: "Campera y pantalón Vans", categoria: "otros" },
    { src: "Imagenes/17-bermudas.jpg", alt: "Bermudas", categoria: "bermudas" },
    { src: "Imagenes/18-remeras-billabong.jpg", alt: "Remeras Billabong", categoria: "remeras" },
    { src: "Imagenes/19-remeras-ripcurl.jpg", alt: "Remeras Ripcurl", categoria: "remeras" }
  ];
  ...
  function filtrarImagenes() {
    return imagenesGaleria.filter(img =>
      categoriaActual === 'all' || img.categoria === categoriaActual
    );
  }
  ...
  function mostrarImagen() {
    ...
    sliderWsp.href = `https://api.whatsapp.com/send?phone=5493425505721&text=Hola! Quiero comprar ${encodeURIComponent(img.alt || 'este producto')}`;
  }
...
btnClientesIzq.addEventListener("click", () => {
  clienteActual = (clienteActual - 1 + clientesImgs.length) % clientesImgs.length;
  mostrarCliente();
});
